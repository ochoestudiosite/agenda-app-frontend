          ...
          {displayServices.map((service, i) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                <div className="w-12 h-12 rounded-2xl bg-ink/5 flex items-center justify-center text-ink group-hover:bg-gold group-hover:text-on-gold transition-colors duration-500">
                  <Sparkles size={20} />
                </div>
                <div className="text-right">
                  <div className="text-2xl font-bold text-ink">${service.price}</div>
                  <div className="text-xs font-medium text-ink-3 uppercase tracking-wider">{service.duration} min</div>
                </div>
              </div>
