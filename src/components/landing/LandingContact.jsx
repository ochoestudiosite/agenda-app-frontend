      ...
      <div className="section-container">
        ...
        <div className="mt-16 lg:mt-20 pt-6 border-t border-edge/40 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="hidden sm:inline-flex items-center gap-1.5 text-[11px] font-medium text-ink-3">
              Hecho con
              <a href="https://cita24.com" target="_blank" rel="noopener noreferrer" className="text-gold hover:underline font-semibold">
                Cita24
              </a>
            </span>
          </div>
