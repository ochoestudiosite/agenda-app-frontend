        ...
        <div className="mb-5">
          {isLoading
            ...
            : <p className="label-section">
                Agenda Digital{bizLocation ? ` · ${bizLocation}` : ''}
              </p>
          }
        </div>
        <h1 className="font-display text-[2.75rem] sm:text-6xl font-bold leading-[1.06] tracking-tightest text-ink mb-6">
          Tu próxima cita,<br />
          con el <em className="not-italic text-gold">especialista perfecto.</em>
        </h1>
        <p className="text-ink-2 text-lg leading-relaxed max-w-md mb-10">
          Reserva en 2 minutos. Sin llamadas, sin esperas. Elige servicio, especialista y horario.
        </p>
        ...
        <div className="relative overflow-hidden rounded-3xl bg-ink dark:bg-card border border-edge p-8 sm:p-12 text-center">
          ...
          <div className="relative">
            ...
            <p className="text-stone-400 dark:text-ink-2 mb-8 max-w-sm mx-auto text-[0.9375rem] leading-relaxed">
              Selecciona tu servicio, elige tu especialista y confirma en segundos.
            </p>
            <Link to="/agendar">
...
const FEATURES = [
  ...
  },
  {
    ...
    description: 'Profesionales certificados con años de experiencia a tu servicio.',
  },
  {
